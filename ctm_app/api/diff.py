...
from ctm_app.core.exceptions import TemplateNotFoundError, VersionNotFoundError
from ctm_app.schemas.diff import DiffResponse
from ctm_app.services import diff_service, version_service
