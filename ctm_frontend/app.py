...
def main() -> None:
    ...
    if page == "Template Registry":
        from ctm_frontend.pages.template_registry import render

        render(client)
    elif page == "Upload Template":
        from ctm_frontend.pages.upload_template import render

        render(client)
    elif page == "Stale Alerts":
        from ctm_frontend.pages.stale_alerts import render
